...
public class Arm extends SubsystemBase {
  ...
  public static final double passthroughConstraintWristRange = Units.degreesToRadians(80.0);
  ...
  public void periodic() {
    ...
    if (currentTrajectory != null
      ...
      double avoidanceLookaheadSecs =
          setpointPose.endEffectorPosition().getX() > cubeIntakeAvoidanceRect[0]
              ? avoidanceLookaheadSecsFromFront
              : avoidanceLookaheadSecsFromBack;
  ...
  public boolean cubeIntakeShouldExtend() {
    return getCollisionTimeRange(cubeIntakeAvoidanceRect, true)[0]
            < (setpointPose.endEffectorPosition().getX() > cubeIntakeAvoidanceRect[0]
                ? avoidanceLookaheadSecsFromFront
                : avoidanceLookaheadSecsFromBack)
