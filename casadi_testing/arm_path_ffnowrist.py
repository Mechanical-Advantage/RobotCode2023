...
ffModel = DoubleJointedArmFeedforward(
  JointConfig(15.0, L[0], 1, L[0] / 2, DCMotor.getNEO(1).withReduction(80.0)),
  JointConfig(10.0, L[1], 1, L[1] / 2, DCMotor.getNEO(1).withReduction(50.0))
)
...
current_time = 0
for i in range(n + 2):
    animation_points.append((current_time, opti.value(theta_points[i][0]), opti.value(theta_points[i][1])))
